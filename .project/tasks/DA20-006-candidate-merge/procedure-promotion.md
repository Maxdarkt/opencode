...
- Candidate : branche `candidate-merge`, worktree
  `/Users/leanbot/Documents/40_Daidalon/features/tasks/DA20-006`, SHA Verify `VERIFY_SHA`.
...
2. Sur le checkout `staging` propre : `git merge VERIFY_SHA` (uniquement cette candidate). Stop au premier conflit non trivial.
