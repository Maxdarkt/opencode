...
|---|---|---|---|---|---|
| Sprint 8 | 4 cartes, 18 SP, merge `6d6de081f` (candidate `cbdf61e67`) | `.project/tasks/DA30-014-*` … `DA20-007-*` | `sprint-8/`, `docs/product/sprints/sprint-8.md` | parent Cursor `3668b277-3781-4430-afef-920874b35ada` | 4 MT archived ; 4 worktrees `features/tasks/` S8 retirés |
