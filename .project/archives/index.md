...
|---|---|---|---|---|---|
| Sprint 6 | 3 cartes, 19 SP, merge `b7d70d3f8` | `.project/tasks/DA10-009-*` … `DA40-018-*` | `sprint-6/`, `docs/product/sprints/sprint-6.md` | parent Cursor `cc8b71bf-fc44-4c64-a875-c5806924b9fb` | 3 MT archived ; worktrees `features/tasks/` S6 à retirer s’ils sont propres |
