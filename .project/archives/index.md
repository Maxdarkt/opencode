...
|---|---|---|---|---|---|
| Sprint 8 | 4 cartes, 18 SP, merge `6d6de081f` (candidate `cbdf61e67`) | `.project/tasks/DA30-014-*` … `DA20-007-*` | `sprint-8/`, `docs/product/sprints/sprint-8.md` | parent Cursor `3668b277-3781-4430-afef-920874b35ada` | 4 MT archived ; sprint `completed` `end_date` 2026-09-25 ; 1 worktree `staging` |
...
| DA40-005 | protocole mémoire reçu | `.project/tasks/DA40-005-memoire-durable-markdown-mt` | `da40-005.md` | `01a07aca-658a-7092-90c4-dbf3e5bbb30d` | MT archived |
| DA40-008 | contrat orchestrateur reçu | `.project/tasks/DA40-008-integrer-contrat-sprint-orchestrator` | `da40-008.md` | `01a07ad6-8047-7311-9cf2-883c2ced3d20` | MT archived |
| DA40-009 | mémoire durable adoptée | `.project/tasks/DA40-009-adopter-memoire-durable-daidalon` | `da40-009.md` | `01a07ae1-9127-7833-96d7-30a75288785e` | MT archived |
| DA40-010 | baseline Sprint 1 assemblée et validée | `.project/tasks/DA40-010-assembler-baseline-commune` | `da40-010.md` | `01a07b3f-d1eb-7400-b644-1af894277c0e` | MT archived |
