export const dict = {
  ...
  "session.banner.running": "En cours",
  "session.banner.idle": "Inactif",
  "session.banner.tool": "Outil",
  "session.banner.cwd": "cwd",
  "session.banner.interrupt": "Interrompre",
  "session.inspector.toggle": "Inspecteur",
  "session.inspector.context": "Contexte",
  "session.inspector.cost": "Coût",
  "session.inspector.task": "Tâche",
  "session.inspector.git": "Git",
  "session.inspector.servers": "Serveurs",
  "session.inspector.servers.makeDev": "make dev",
  "session.inspector.servers.start": "Démarrer",
  "session.inspector.servers.stop": "Arrêter",
  "session.inspector.servers.cpuRam": "CPU / RAM",
  "session.inspector.permissions": "Permissions",
  "session.inspector.status": "Statut",
  "session.inspector.branch": "Branche",
  "session.inspector.head": "HEAD",
  "session.inspector.dirty": "Dirty",
  "session.inspector.review": "Review",
  "session.inspector.merge": "Merge",
  "session.inspector.mergeSimulated": "Simulation — aucun effet",
  "session.inspector.worktree": "Worktree",
  "session.inspector.mandate": "Mandat",
  "session.inspector.pathset": "Pathset",
  "session.inspector.omitted": "Omises",
  "session.inspector.tokensBefore": "Jetons avant",
  "session.inspector.tokensAfter": "Jetons après",
  "session.inspector.tokens": "Jetons",
  "session.inspector.empty": "vide",
  ...
  "sprint.cockpit.title": "Sprint cockpit",
  "sprint.cockpit.readOnlyBanner": "Read-only projections · no mutation",
  "sprint.cockpit.inaccessibleBanner": "Projections inaccessible · facts unknown",
  "sprint.cockpit.taskStack": "Sprint task stack",
  "sprint.cockpit.pilotChat": "Sprint cockpit · read-only",
  "sprint.cockpit.taskChat": "Task surface · local tabs only",
  "sprint.cockpit.backToCockpit": "Back to cockpit",
  "sprint.cockpit.statusLabel": "Status",
  "sprint.cockpit.worktree": "Worktree",
  "sprint.cockpit.branchHead": "Branch · HEAD",
  "sprint.cockpit.budget": "Budget",
  "sprint.cockpit.selectedTask": "Selected task",
  "sprint.cockpit.sprint": "Sprint",
  "sprint.cockpit.contextNote": "Sensitive actions are simulated. Git promotion targets staging only. Force-push and master/develop are refused. No chat, terminal, Git, browser, MT or APEX mutation is connected.",
  "sprint.cockpit.confirmationTitle": "Confirm simulated action",
  "sprint.cockpit.confirmationDescription": "The action '{{action}}' is displayed for review only and will not run. Git promotion is staging only — never force-push, never master or develop.",
  "sprint.cockpit.launchTitle": "Ouvrir le chat de la tâche",
  "sprint.cockpit.launchDescription": "Ouvrir ou reprendre le chat unique lié à ce worktree de carte.",
  "sprint.cockpit.confirmLaunch": "Ouvrir le chat",
  "sprint.cockpit.launchFailed": "Impossible d’ouvrir le chat de la tâche",
  "sprint.cockpit.simulationBanner": "Simulation — no effect",
  "sprint.cockpit.cancel": "Cancel",
  "sprint.cockpit.confirmSimulation": "Acknowledge simulation",
  "sprint.cockpit.preview.chat": "Chat",
  "sprint.cockpit.preview.terminal": "Terminal",
  "sprint.cockpit.preview.git": "Git / Diff",
  "sprint.cockpit.preview.browser": "Browser",
  "sprint.cockpit.action.launch": "Launch",
  "sprint.cockpit.action.commit": "Commit",
  "sprint.cockpit.action.merge": "Merge",
  "sprint.cockpit.action.production": "Production",
  "sprint.cockpit.panel.title": "Task context",
  "sprint.cockpit.panel.tabs": "Task context views",
  "sprint.cockpit.panel.taskStatus": "Task status",
  "sprint.cockpit.panel.verifiableContext": "Verifiable context",
  "sprint.cockpit.panel.repositoryTopology": "Repository topology",
  "sprint.cockpit.canvas.title": "Exchange and tools canvas",
  "sprint.cockpit.canvas.tabs": "Task exchange tools",
  "sprint.cockpit.canvas.inert": "Local tab · no PTY or review runtime",
  "sprint.cockpit.openSession": "Open existing session",
  "sprint.cockpit.closeContext": "Close",
  "sprint.cockpit.openContext": "Open context",
  "sprint.cockpit.fact.unknown": "unknown",
  "sprint.cockpit.rail.working": "Task running",
  "sprint.cockpit.rail.unreadUpdate": "Unread task update",
  "sprint.cockpit.rail.noIndicator": "No additional indicator",
  "sprint.cockpit.rail.taskAccessible": "{{id}} — {{title}} — status {{status}} — {{indicators}}",
  "sprint.cockpit.rail.eligible": "Eligible",
  "sprint.cockpit.rail.blocked": "Blocked",
  "sprint.cockpit.copyPrompt": "Copy prompt",
  "sprint.cockpit.copyPromptSuccess": "Prompt copied",
  "sprint.cockpit.copyPromptFailed": "Could not copy prompt",
  "sprint.cockpit.pilotNoWriteTools": "No write tools — pilot does not code",
  "sprint.cockpit.topology.sourceRepo": "Source repository",
  "sprint.cockpit.topology.reintegration": "Cible de merge : {{target}}",
  "session.workbench.rail.title": "Sprint · chats",
  "session.workbench.rail.pilot": "Pilote",
  "session.workbench.rail.pilotHint": "Cockpit sprint",
  "session.workbench.tray.split": "Split",
  "session.workbench.tray.humanNote": "Humain · pas la trace agent",
  "session.workbench.tray.unknown": "unknown",
  "session.secondary.toggle": "Panneau secondaire",
  "session.secondary.files": "Files",
  "session.secondary.diff": "Git Diff",
  "session.secondary.browser": "Browser",
  "session.secondary.add": "Ajouter",
  "session.secondary.close": "Fermer",
  "session.secondary.explorer": "Explorer",
  "session.secondary.diff.crumb": "Modifs de ce chat",
  "session.secondary.diff.empty": "Aucun diff dans ce chat",
  "session.secondary.browser.hint": "Démarre make dev dans l’inspecteur Serveurs.",
  "session.secondary.browser.addTab": "+ onglet",
  "session.secondary.browser.simulated": "Simulation — aucun effet",
}
