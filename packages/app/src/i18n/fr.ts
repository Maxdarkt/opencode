export const dict = {
  ...
  "sprint.cockpit.contextNote": "Sensitive actions are simulated. No chat, terminal, Git, browser, MT or APEX mutation is connected.",
  "sprint.cockpit.confirmationTitle": "Confirm simulated action",
  "sprint.cockpit.confirmationDescription": "The action '{{action}}' is displayed for review only and will not run.",
