...
export const dict = {
  ...
  "session.banner.running": "Running",
  "session.banner.idle": "Idle",
  "session.banner.tool": "Tool",
  "session.banner.cwd": "cwd",
  "session.banner.interrupt": "Interrupt",
  "session.inspector.toggle": "Inspector",
  "session.inspector.context": "Context",
  "session.inspector.cost": "Cost",
  "session.inspector.task": "Task",
  "session.inspector.git": "Git",
  "session.inspector.servers": "Servers",
  "session.inspector.servers.makeDev": "make dev",
  "session.inspector.servers.start": "Start",
  "session.inspector.servers.stop": "Stop",
  "session.inspector.servers.cpuRam": "CPU / RAM",
  "session.inspector.permissions": "Permissions",
  "session.inspector.status": "Status",
  "session.inspector.branch": "Branch",
  "session.inspector.head": "HEAD",
  "session.inspector.dirty": "Dirty",
  "session.inspector.review": "Review",
  "session.inspector.merge": "Merge",
  "session.inspector.mergeSimulated": "Simulation — no effect",
  "session.inspector.worktree": "Worktree",
  "session.inspector.mandate": "Mandate",
  "session.inspector.pathset": "Pathset",
  "session.inspector.omitted": "Omitted",
  "session.inspector.tokensBefore": "Tokens before",
  "session.inspector.tokensAfter": "Tokens after",
  "session.inspector.tokens": "Tokens",
  "session.inspector.empty": "empty",
  ...
  "sprint.cockpit.launchTitle": "Open task chat",
  "sprint.cockpit.launchDescription": "Open or resume the single chat bound to this card worktree.",
  "sprint.cockpit.confirmLaunch": "Open chat",
  "sprint.cockpit.launchFailed": "Could not open the task chat",
  ...
  "sprint.cockpit.topology.reintegration": "Merge target: {{target}}",
  "session.workbench.rail.title": "Sprint · chats",
  "session.workbench.rail.pilot": "Pilot",
  "session.workbench.rail.pilotHint": "Sprint cockpit",
  "session.workbench.tray.split": "Split",
  "session.workbench.tray.humanNote": "Human · not the agent trace",
  "session.workbench.tray.unknown": "unknown",
  "session.secondary.toggle": "Secondary panel",
  "session.secondary.files": "Files",
  "session.secondary.diff": "Git Diff",
  "session.secondary.browser": "Browser",
  "session.secondary.add": "Add",
  "session.secondary.close": "Close",
  "session.secondary.explorer": "Explorer",
  "session.secondary.diff.crumb": "Changes in this chat",
  "session.secondary.diff.empty": "No diffs in this chat",
  "session.secondary.browser.hint": "Start make dev in the Servers inspector.",
  "session.secondary.browser.addTab": "+ tab",
  "session.secondary.browser.simulated": "Simulation — no effect",
}
