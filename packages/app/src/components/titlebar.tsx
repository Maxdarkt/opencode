...
import { homeNewSessionDirectory, projectForHomeDirectory } from "@/pages/home/home-controller"
          ...
          {(_) => {
            ...
            const openNewTab = () => {
              ...
              if (route.type === "home") {
                ...
                const project = conn
                  ? projectForHomeDirectory(global.ensureServerCtx(conn).projects.list(), selection.directory)
                  : undefined
