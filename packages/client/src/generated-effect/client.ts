...
type Endpoint3_15Request = Parameters<RawClient["server.session"]["session.pack"]>[0]
...
const Endpoint3_15 = (raw: RawClient["server.session"]) => (input: Endpoint3_15Input) =>
  raw["session.pack"]({ params: { sessionID: input["sessionID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )
...
type Endpoint11_0Request = Parameters<RawClient["server.makeDev"]["makeDev.status"]>[0]
type Endpoint11_0Input = { readonly location?: Endpoint11_0Request["query"]["location"] }
const Endpoint11_0 = (raw: RawClient["server.makeDev"]) => (input?: Endpoint11_0Input) =>
  raw["makeDev.status"]({ query: { location: input?.["location"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint11_1Request = Parameters<RawClient["server.makeDev"]["makeDev.start"]>[0]
type Endpoint11_1Input = { readonly location?: Endpoint11_1Request["query"]["location"] }
const Endpoint11_1 = (raw: RawClient["server.makeDev"]) => (input?: Endpoint11_1Input) =>
  raw["makeDev.start"]({ query: { location: input?.["location"] } }).pipe(Effect.mapError(mapClientError))

type Endpoint11_2Request = Parameters<RawClient["server.makeDev"]["makeDev.stop"]>[0]
type Endpoint11_2Input = { readonly location?: Endpoint11_2Request["query"]["location"] }
const Endpoint11_2 = (raw: RawClient["server.makeDev"]) => (input?: Endpoint11_2Input) =>
  raw["makeDev.stop"]({ query: { location: input?.["location"] } }).pipe(Effect.mapError(mapClientError))

const adaptGroup11 = (raw: RawClient["server.makeDev"]) => ({
  status: Endpoint11_0(raw),
  start: Endpoint11_1(raw),
  stop: Endpoint11_2(raw),
})
...
const adaptClient = (raw: RawClient) => ({
  ...
  makeDev: adaptGroup11(raw["server.makeDev"]),
